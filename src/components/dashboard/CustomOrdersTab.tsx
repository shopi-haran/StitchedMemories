          ...
          {filteredOrders.map((order) => {
            ...
            return (
              ...
              >
                ...
                {/* Live Stitch Progress Preview Bar for Custom Stitched Orders */}
                {isCustomStitched && (isInProduction || progressPercent > 0) && (
        ...
        return (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fadeIn overflow-y-auto">
            ...
            >
              ...
              {/* LIVE WORKSHOP PROGRESS (if custom stitched in production or has progress) */}
